...
To determine whether the coldpressor dependent variable was a sensitive measure of aggression, I tested whether these participant evaluations were related to coldpressor assignments. First, a principal component was extracted from participants’ six ratings of the interaction, described above. The first component accounted for 54% of the variance and had the expected pattern of loadings: .51, .45, and .50 for irritation, anger, and annoyance, -.35, -.22, and -.33 for happiness, helpfulness, and pleasure. This component, hereafter referred to as composite irritation, was then used as a linear predictor of coldpressor assignment. The relationship was moderately strong, `r report_t(check2, "feedback.NA"); F2R(summary(check2)$fstatistic[1], check2$df.residual+2)`, suggesting that the coldpressor measure was indeed influenced by participants’ intent to aggress. A scatterplot and loess regression line are provided in Figure 1.
