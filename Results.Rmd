...
To determine whether the coldpressor dependent variable was a sensitive measure of aggression, we tested whether these participants more provoked by the feedback gave higher coldpressor assignments. Parallel analysis suggested a two-factor solution for participants' ratings of their interaction with their partner. Factors were extracted using oblimin rotation. The first factor accounted for 52% of the variance and had the expected pattern of loadings: .77, .76, and .67 for irritation, anger, and annoyance, -.25, .02, and .02 for happiness, helpfulness, and pleasure. This provocation factor was then used as a linear predictor of coldpressor assignment. The relationship was moderately strong, `r report_t(check2, "feedback.NA", "r", 275/2, 275/2)`, suggesting that the coldpressor measure was indeed influenced by participants’ intent to aggress. A scatterplot and loess regression line are provided in Figure 1.
